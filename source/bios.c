...
uint8 *ngpc_bios = 0;			// Holds bios program data
...
bool installHleBios(uint8 *ngpBios)
{
	...
	{
		*(uint32*)(ngpBios + 0xFE00 + (i * 4)) = callTable[i];
	...
	{
		*(uint32*)(ngpBios + 0xFF00 + (i * 4)) = irqTable[i];
